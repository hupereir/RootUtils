...
template< class T>
std::vector<T> makeVector( T* values, int size )
...
void Utils::TGraphToC( TGraphErrors* tgraph, TString xLabel, TString yLabel )
{
  ...
  Stream::PrintVector( xLabel.Data(), makeVector( tgraph->GetX(), nBins ), "%.3g" );
  Stream::PrintVector( Form( "%sErr", xLabel.Data() ), makeVector( tgraph->GetEX(), nBins ), "%.3g" );

  Stream::PrintVector( yLabel.Data(), makeVector( tgraph->GetY(), nBins ), "%.3g" );
  Stream::PrintVector( Form( "%sErr", yLabel.Data() ),  makeVector( tgraph->GetEY(), nBins ), "%.3g" );
